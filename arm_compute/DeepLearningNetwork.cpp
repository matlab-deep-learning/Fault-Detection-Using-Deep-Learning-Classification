...
void b_TrainedModel_0::setup()
{
  ...
  (dynamic_cast<MWLSTMLayer *>(this->layers[1]))->createLSTMLayer
    (this->targetImpl, this->layers[0]->getOutputTensor(0), 10, 100, false, true,
     1, "./arm_compute/cnn_TrainedModel_biLSTM_1_w.bin",
     "./arm_compute/cnn_TrainedModel_biLSTM_1_b.bin",
     "./arm_compute/cnn_TrainedModel_biLSTM_1_hx.bin",
     "./arm_compute/cnn_TrainedModel_biLSTM_1_cx.bin", 1);
  ...
  (dynamic_cast<MWLSTMLayer *>(this->layers[3]))->createLSTMLayer
    (this->targetImpl, this->layers[2]->getOutputTensor(0), 200, 100, true, true,
     1, "./arm_compute/cnn_TrainedModel_biLSTM_2_w.bin",
     "./arm_compute/cnn_TrainedModel_biLSTM_2_b.bin",
     "./arm_compute/cnn_TrainedModel_biLSTM_2_hx.bin",
     "./arm_compute/cnn_TrainedModel_biLSTM_2_cx.bin", 0);
  (dynamic_cast<MWFCLayer *>(this->layers[4]))->createFCLayer(this->targetImpl,
    this->layers[3]->getOutputTensor(0), 200, 8,
